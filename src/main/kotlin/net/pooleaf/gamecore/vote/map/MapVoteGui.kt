    ...
    init {
        ...
        val randomIcon = object : InventoryIcon() {
            override fun updateItem(): ItemStack {
                val randomVotedCount = GameCore.playerManager.getOnlineJoinedPlayers().size - GameCore.mapVoteService.mapVote.getVoteCount()
            ...
            override fun onClick(event: InevntoryGuiClickEvent) {
                ...
                gamePlayer?.let {
                    GameCore.mapVoteService.voteToRandom(it)
        ...
        GameCore.mapManager.values().forEach { map ->
            val mapIcon = object : InventoryIcon() {
                ...
                override fun updateItem(): ItemStack {
                    val votedCount = GameCore.mapVoteService.mapVote.getVoteCount(gameMap)
                ...
                override fun onClick(event: InevntoryGuiClickEvent) {
                    ...
                    gamePlayer?.let {
                        GameCore.mapVoteService.voteTo(gamePlayer, gameMap)
                        it.playSoundSafely(XSound.UI_BUTTON_CLICK)
