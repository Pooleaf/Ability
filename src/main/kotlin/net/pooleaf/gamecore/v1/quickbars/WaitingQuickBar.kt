package net.pooleaf.gamecore.v1.quickbars
    ...
    init {
        ...
        if (GameCore.quickBarConfig.useWaitingStartVote) {
            startVoteSlot = object : Slot() {
                ...
                override fun onClick(event: SlotClickEvent) {
                    ...
                    GameCore.startVoteManager.startVoteGui.open(event.player)
                }
            }
        }
        ...
        if (GameCore.quickBarConfig.useWaitingMapVote) {
            mapVoteSlot = object : Slot() {
                ...
                override fun onClick(event: SlotClickEvent) {
                    ...
                    GameCore.mapVoteManager.mapVoteGui.open(event.player)
                }
            }
        }
        ...
        val toggleObserverSlot = object : FakeSlot() {
            override fun updateItem(player: Player): ItemStack {
                ...
                val itemStack = if (gamePlayer?.let { it.observer } == true) {
