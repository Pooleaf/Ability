    ...
    init {
        ...
        val agreeIcon = object : InventoryIcon() {
            override fun updateItem(): ItemStack {
                val agreePlayerCount = GameCore.startVoteManager.startVote.agreePlayers.size
            ...
            override fun onClick(event: InevntoryGuiClickEvent) {
                ...
                gamePlayer?.let {
                    GameCore.startVoteManager.voteToAgree(it)
        ...
        val disagreeIcon = object : InventoryIcon() {
            override fun updateItem(): ItemStack {
                val disagreePlayerCount = GameCore.startVoteManager.startVote.disagreePlayers.size
            ...
            override fun onClick(event: InevntoryGuiClickEvent) {
                ...
                gamePlayer?.let {
                    GameCore.startVoteManager.voteToDisagree(it)
                    it.playSoundSafely(XSound.UI_BUTTON_CLICK)
